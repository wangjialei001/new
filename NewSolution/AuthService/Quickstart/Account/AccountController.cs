    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var userInfo = _db_TestContext.User.FirstOrDefault(t => t.Name == model.Username);
                ...
                if (userInfo != null && string.Equals(model.Password, userInfo.Pwd))
                {
                    ...
                    else if (!string.IsNullOrEmpty(model.ReturnUrl) && (model.ReturnUrl.StartsWith("http://") || model.ReturnUrl.StartsWith("https://")))
                    {
                        return Redirect(model.ReturnUrl);
                    }
                    else
